...
#for showing signup/login button for admin(by HMS)
...
#for showing signup/login button for doctor(by HMS)
...
#for showing signup/login button for patient(by HMS)
...
#-----------for checking user is doctor , patient or admin(by HMS)
def is_admin(user):
